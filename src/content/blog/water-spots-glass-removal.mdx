...
For the paint surface receiving the same sprinkler exposure, the process is different. See our post on [paint water spot removal](/blog/water-spots-florida-well-water/) for the clay bar and sealant sequence that addresses mineral damage on clear coat. If the deposits came from Tampa Bay area rain chemistry rather than well water sprinklers, [hard water spots and Tampa Bay rain damage](/blog/hard-water-spots-tampa) covers the dissolved pollutant angle and why rain-deposited spots are often more chemically aggressive than sprinkler deposits.
