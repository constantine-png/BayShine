...
Tar and tree sap are a specific decontamination category that clay bar alone does not address — they require solvent pre-treatment before clay will lift them cleanly. [Tar and sap removal from car paint: the correct process for Florida vehicles](/blog/tar-sap-removal-car-paint) covers the right sequence and why scrubbing causes damage the chemistry approach avoids.
