...
const CHAPTERS = [
  {
    ...
    body: [
      'Modern automotive paint is a 4-layer system: electrocoat primer, base coat (color), clear coat, and sometimes a ceramic factory coat. The clear coat — typically 40–80 microns — is everything you work with. Every polishing step removes some of it. There\'s no adding it back.',
  ...
  },
  {
    ...
    body: [
      'Car wash shampoos work through surfactant chemistry: hydrophilic heads attach to water, hydrophobic tails attach to soil particles, and agitation lifts them off the surface. The pH matters because it determines aggressiveness — pH 7–8 is gentle on wax and sealants; pH 9–11 will strip them in one wash.',
  ...
  },
  {
    ...
    body: [
      'Protection sits on top of paint, not inside it. Carnauba wax provides warmth and depth but typically lasts 6–8 weeks. Synthetic sealants last 4–6 months and perform better under UV. Ceramic coatings create a semi-permanent bond with the clear coat — 9H hardness, hydrophobic, and self-cleaning. They also require proper prep: the surface has to be corrected first.',
      'Ceramic application requires controlled temperature (60–80°F), low humidity, and clean paint with no oils or polishing residue. Panel wipe with IPA is mandatory. The coating requires 24 hours of no-water curing and reaches full hardness at 7–14 days. Rushing either window produces substandard results.',
    ],
  },
  {
    num: '06',
    ...
    body: [
      ...
      'Steam cleaning removes embedded dirt and sanitizes without chemical residue. The right temperature is 230–280°F — hot enough to sanitize and lift grime, low enough to not damage leather or plastics. Extraction removes moisture before it molds. Conditioning comes last: leather conditioner on a dry, clean surface.',
    ],
  },
  {
    num: '07',
    title: 'Marine Considerations',
    subtitle: 'Salt, oxidation, and gel coat',
    keyPoints: ['Gel coat is not automotive paint', 'Salt contamination requires dedicated removal', 'Oxidation assessment before quoting'],
    body: [
      'Marine gel coat is polyester resin — harder and more porous than automotive clear coat. The correction process is similar but the abrasives and pads differ. Oxidation turns gel coat chalky and dull; moderate oxidation comes back with compound + polish, heavy oxidation may require wet sanding first.',
      'Salt contamination from marine environments is pervasive. It\'s in every crevice, every fastener, and on every surface. Pre-rinse with fresh water before washing. Salt attracts moisture and accelerates corrosion — removing it is maintenance, not optional cleaning.',
    ],
  },
  {
    num: '08',
    ...
    body: [
      'Fleet work operates on completely different economics than retail detailing. The goal is consistent, professional results at speed. Not show-car finish — presentable, clean, and uniform across 30–300 units. That means standardized process, trained sequence, and product systems that work the same in every condition.',
  ...
  return (
    <div className="book-perspective w-full max-w-3xl mx-auto select-none">
      ...
      {stage === 'cover' && (
        ...
        >
          <div className="book-page-face">
            <div className="relative bg-bay-deep border border-bay-gold/20 rounded-sm overflow-hidden"
                 style={{ minHeight: 480 }}>
              {/* Spine accent */}
      ...
      {stage === 'toc' && (
        ...
        >
          <div className="book-page-face">
            <div className="bg-bay-deep border border-bay-gold/20 rounded-sm overflow-hidden">
          ...
          <div className="book-page-face">
            <div className="bg-bay-deep border border-bay-gold/20 rounded-sm overflow-hidden">
              ...
              <div className="p-8 md:p-12">
                ...
                {/* Key points */}
                <div className="bg-bay-navy/40 rounded-sm p-4 mb-6">
